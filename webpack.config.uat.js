...
module.exports = {
    ...
    output: {
        ...
        publicPath: '/cc-contract/changgui-static/tmp/'
    ...
    plugins: [
        new webpack.DefinePlugin({ //<--key to reduce React's size
            'process.env': {
                ...
                'CINTRACT': JSON.stringify('http://qywx.uat.shbaoyuantech.com/cc-contract'),//合同
                'CLUE': JSON.stringify("http://qywx.uat.shbaoyuantech.com/cc-contract")  //线索
            }
        }),
        ...
        new ExtractTextPlugin('styles-[chunkhash:5].css'),
        ...
        new ZipFilesPlugin({
            ...
            output: path.join(__dirname, './clue_contract_uat'),
            format: 'zip'
        }),
