...
module.exports = {
    entry: {
        ...
        lib: [ 'react', 'react-dom', 'react-router-dom', 'react-redux', __dirname + '/src/base.js' ]
    },
    output: {
        path: __dirname + '/tmp/',
    ...
    plugins: [
        new webpack.DefinePlugin({ //<--key to reduce React's size
            'process.env': {
                ...
                'CINTRACT': JSON.stringify('http://qywx.build.shbaoyuantech.com/cc-contract'),//合同
                'CLUE': JSON.stringify("http://qywx.build.shbaoyuantech.com/cc-contract")  //线索
            }
        }),
